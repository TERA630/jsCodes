...
function showTreatment(){
 ...
 let  recommendOfAntiHypertensive = decideAntihypertensive(dataOfrecommend[3],gradeOfCKD,gradeOfAge);
...
function decideSGLT2i(grade_of_CKD,grade_of_age){
  //  DMR uACR>25mg/mmol 冠動脈疾患、うっ血性心不全 Grade1A(UKKA)
  ...
  // PKDや免疫抑制がなければ蛋白尿uACR＞25ならばGrade1B  
